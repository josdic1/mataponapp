...
import { eventActivityStaffRouter } from "./routes/eventActivityStaff.js";
import { qualificationsRouter } from "./routes/qualifications.js";
import { activityQualificationsRouter } from "./routes/activityQualifications.js";
import { staffQualificationsRouter } from "./routes/staffQualifications.js";
...
app.use("/api/event-activity-staff", eventActivityStaffRouter);
app.use("/api/qualifications", qualificationsRouter);
app.use("/api/activity-qualifications", activityQualificationsRouter);
app.use("/api/staff-qualifications", staffQualificationsRouter);
